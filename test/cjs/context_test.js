...
const { Context } = require('automerge/frontend/context')
const { CACHE, OBJECT_ID, CONFLICTS, STATE, ELEM_IDS } = require('automerge/frontend/constants')
const { Counter } = require('automerge/frontend/counter')
const { Table, instantiateTable } = require('automerge/frontend/table')
const { Text } = require('automerge/frontend/text')
const { uuid } = require('automerge')
