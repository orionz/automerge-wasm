...
const { DOC_OPS_COLUMNS, encodeChange, decodeChange, encodeDocument, decodeDocument, BackendDoc } = require('automerge/backend/columnar')
const { uuid } = require('../../cjs/index')
